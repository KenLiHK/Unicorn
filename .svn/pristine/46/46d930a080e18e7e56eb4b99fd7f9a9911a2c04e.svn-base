                				...
                				<div class="orderTable">
                                  ...
                                  <div class="info">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <input class="cart_radio" type="radio" id="paymentMethod1" name="paymentMethod" value="CR" onclick="clickCreditCard()" <?php if (isset($_paymentMethod) && $_paymentMethod=="CR") echo "checked";?>>Credit Card <br>
                                            ...
                                            <input class="cart_radio" type="radio" id="paymentMethod2" name="paymentMethod" value="CA" onclick="clickCash()" <?php if (isset($_paymentMethod) && $_paymentMethod=="CA") echo "checked";?>>Cash <br>                                            
								  ...
								  <div>								  	  
									  <input class="placeOrder_button" type="submit" id="SubmitBtn" name="SubmitBtn" value="Submit">
								   </div>				
								</div>
