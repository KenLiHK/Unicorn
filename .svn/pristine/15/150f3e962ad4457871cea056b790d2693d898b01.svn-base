						...
						<div>
							<div>
								...
								<div class="container">
									...
									<div>
										<label class="reg_label">User ID : </label><label class="mandatory_field">*</label> 
									...
									<div>
										<label class="reg_label">Email : </label><label class="mandatory_field">*</label> 
									...
									<div>
										<label class="reg_label">Password : </label><label class="mandatory_field">*</label> 
									...
									<div>
										<label class="reg_label">Repeat Password : </label><label class="mandatory_field">*</label> 
									...
									<div>
										<label class="reg_label">English Surname : </label><label class="mandatory_field">*</label> 
									...
									<div>
										<label class="reg_label">English Middle Name : </label><label class="mandatory_field">*</label> 
									...
									<div>
										<label class="reg_label">Contact Phone No. : </label><label class="mandatory_field">*</label> 
									...
									<label class="reg_label">Delivery Address : </label><label class="mandatory_field">*</label>
									<div>										
									...
									<div>
										...
										<label class="reg_label">By creating an account you agree to our <a href="./registerTerms&Conditions.php" >Terms & Conditions</a>.</label><label class="mandatory_field">*</label>
									...
									<div>
									  ...
									  <br><br><label class="reg_label"><u>Password format advices:</u></label>
									  <br><label class="reg_label2">Password length must be 8 - 20 characters.</label>
									  <br><label class="reg_label2">Password must contain at least 2 upper case characters.</label>
									  <br><label class="reg_label2">Password must contain at least 2 lower case characters.</label>
									  <br><label class="reg_label2">Password must contain at least 2 numeric characters.</label>
									  <br><label class="reg_label2">Password must contain at least 2 special characters.</label>
									</div>
								  </div>
