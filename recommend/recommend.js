...
function loadSec(){
    $('#id_foodCategory').change(
            function prepareSearchBox(){
            	var $foodCate = document.getElementById("id_foodCategory").value;
            	var $foodName = document.getElementById("id_searchFood").value;
            	...
            	if($foodCate == ""){
            		...
            		$.cookie('unicornCookie', $foodCate, (30 * 24 * 3600));
            	}
     });
}
...
function addCartAnimate($foodId){
        ...
        /*
         *         var imgIdT1 = "#imgSearch_" + $foodId;
        var imgIdT2 = "#imgFoodCate_" + $foodId;
        var imgIdT3 = "#imgFoodRec_" + $foodId;
        if(imgtodrag.offset() != undefined){
        	imgId = imgIdT1;
        }else{
        	imgtodrag = $(imgIdT2);
        	if(imgtodrag.offset() != undefined){
	...
	$.ajax(
        {
            ...
            success:function(result){
                ...
                if(result["code"]!=0){
                    ...
                    $.each(result["data"],function(i,n){
                        var $foodCategory 	= n["food_category"];
...
function prepareFoodDetail($_oriPrice, $_disPrice, $_imgPath, $_cateName, $_foodName, $_foodId, $_intColor, $_section){
	...
	'					<div class="font-weight-bold-height2">$'+ $_disPrice +'</div>												            ' +		
	'				</div>																									                    ' +
	'			</div>																										                    ' +	
	'			<div class="row">																							                    ' +
